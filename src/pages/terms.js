  ...
  return (
    <main className="terms">
      <Section padBtm="0px">
        ...
        <h3 className="title_small">Terms of Service</h3>
        <p>
        ...
        <ol>
          <li>
            We reserve the right to update and change these terms of service at
            any time without notice. It is your responsibility to periodically
            review these terms for any updates or changes.
          </li>
          <li>
            We do not guarantee that our web application will always be
            available or error-free. We will make reasonable efforts to maintain
            the availability of the web application, but cannot be held
            responsible for any interruptions or errors.
          </li>
          <li>
          ...
          <li>
            You must not use our web application for any illegal or unauthorized
            purposes. You must not violate any laws in your jurisdiction,
          ...
          <li>
            ...
            or share on our web application. You are solely responsible for any
            content that you post, and we do not endorse any content posted by
            users of our web application.
          </li>
          <li>
            We may use cookies and other tracking technologies to improve the
            functionality of our web application. By using our web application,
        ...
        <h3 className="title_small">Privacy Policy</h3>
        <p>
        ...
        <ol>
          <li>
            We collect certain personal information from you when you create an
            account with Bzy, such as your name and email address. We also
          ...
          <li>
            ...
            improve our web application, and to communicate with you about your
          ...
          <li>
            ...
            you of any changes by posting the updated policy on our web
            application, and we encourage you to periodically review this policy
            for any updates or changes.
          </li>
        </ol>
        <p>
          By using Bzy, you agree to the collection, use, and disclosure of your
